  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          const SizedBox(height: 20), // Mengurangi jarak agar foto login lebih dekat
          const Center(
            child: CircleAvatar(
          ...
          // Mengatur posisi teks "Jenjang Pendidikan" ke kiri
          const Align(
            alignment: Alignment.centerLeft,
            child: Padding(
              padding: EdgeInsets.only(left: 16.0), // Menambahkan padding dari kiri
              child: Text(
                "Jenjang Pendidikan",
